...
export const MATCH_INTERACTED_USER_CHAIN =
    ...
    '(post)-[posted]->(thread:Thread)<-[:HasThread]-(bite:Bite)';
...
export const MATCH_INTERACTED_BITE_CHAIN =
    ...
    '(thread:Thread)<-[posted]-(post)<-[:Authored]-(authoredUser:User)';
...
export const MATCH_SIMILAR_BITE_CHAIN =
    ...
    '-[:HasThread]->(thread:Thread)<-[posted]-(post)<-[:Authored]-(authoredUser:User)';
